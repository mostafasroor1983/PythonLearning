...
# Checking string equality after cleaning
s1 = " Python "
s2 = "python "
print(f"Strings are equal after cleaning: {s1.strip() == s2.strip()}")
print(f"Strings are equal ignoring case: {s1.lower() == s2.lower()}")
print(f"Strings are equal after cleaning ignoring case: {s1.lower().strip() == s2.lower().strip()}")
